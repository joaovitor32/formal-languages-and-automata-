...
def transition_function(initialState,input_string,transitions,output):
    outputString = ''
    resp = initial_state
...
class Finite_State_Machine:
    def __init__(self,states,input_string,initial_state,transition_function):
        self.states = states 
...
if __name__=="__main__":    
    ...
    while main:
        ...
        MEF = Finite_State_Machine(states,input_string,initial_state,transition_function)
        MEF.execute()
